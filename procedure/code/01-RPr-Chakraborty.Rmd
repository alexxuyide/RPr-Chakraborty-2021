...
### Alex's deviation: changing the population upper bound in Kulldorff spatial scan to 15%

Do the same thing for pop upper bound = 15%
...
### Alex's deviation: changing the population upper bound in Kulldorff spatial scan to 10%

Do the same thing for pop upper bound = 10%
...
### Alex's deviation: changing the population upper bound in Kulldorff spatial scanto 5%

Do the same thing for pop upper bound = 5%
