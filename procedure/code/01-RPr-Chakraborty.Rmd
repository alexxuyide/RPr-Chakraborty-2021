...
covid_kulldorff_015  <- readRDS(
  here("data", "derived", "public", "covid_kulldorff_015_2023-10-01.RDS")
)

covid_kulldorff_010  <- readRDS(
  here("data", "derived", "public", "covid_kulldorff_010.RDS")
)

covid_kulldorff_005  <- readRDS(
  here("data", "derived", "public", "covid_kulldorff_005.RDS")
)
```
...
### Alex's New Map
Mapping the difference between the cluster relative risk class and the county relative risk class
